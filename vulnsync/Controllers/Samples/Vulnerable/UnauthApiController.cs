...
public class UnauthApiController : Controller
{
    ...
    [HttpGet("previllege")]
    public IActionResult VulnerableUser()
    {
        try
        {
            ...
            return RedirectToAction("VulnerableAdmin");
        }
        catch (Exception ex)
        {
    ...
    public IActionResult VulnerableAdmin()
    {
        try
        {
            ...
            if (!System.IO.File.Exists(jsonPath))
            {
                ...
                return View("Vulnerable/Admin", new List<TenantInfo>());
            }
            ...
            return View("Vulnerable/Admin", tenantsData.Tenants);
        }
        catch (Exception ex)
        {
    ...
    [HttpGet("user")]
    public IActionResult VulnerableUserDashboard()
    {
        try
        {
            ...
            return View("Vulnerable/User", dashboardItems);
        }
        catch (Exception ex)
        {
