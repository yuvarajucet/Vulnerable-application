...
public class CsrfController : Controller
{
    ...
    public IActionResult SecureUpdatePassword() 
    { 
        return View("Secured/Updatepassword"); 
    }

    [HttpPost("Updatepassword")]
    [ValidateAntiForgeryToken]
    public IActionResult SecureUpdatePassword(string newPassword, string confirmPassword)
    {
